...
function Sidebar() {
  ...
  const signOut = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        localStorage.clear();
        toast.success(result.message_logout || "Signing Out")
        setTimeout(() => {
      ...
      <div className="sidebar">
        ...
        <div className="sidebar-menu">
          <div className="sidebar-menu-list py-3 bdr-bottom">
            ...
            <button
              className={`sidebar-menu-list-item w-100 collapsable collapsed ${
            ...
            <Collapse in={openSection.section1}>
              <ul className="sidebar-menu-list-sub" id="collapseOne">
                <li>
                  <NavLink to="/manage-campaign">Overview</NavLink>
                </li>
                <li>
            ...
            <Collapse in={openSection.section3} id="collapseThree">
              <ul className="sidebar-menu-list-sub">
                <li>
                  <NavLink to="/inventories/overview">Overview</NavLink>
                </li>
                <li>
